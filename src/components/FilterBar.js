                ...
                <div className="py-4 overflow-y-auto">
                    <ul className="text-slate-700 dark:text-slate-100">
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-censter my-1">
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                <input onChange={() => dispatch({ type: "IN_STOCK_ONLY", payload: { onlyInStock: !state.onlyInStock } })} checked={state.onlyInStock || false} id="only-instock" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
