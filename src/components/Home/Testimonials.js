...
const Testimonials = () => {
  return (
    ...
    <section className='my-4 max-w-7xl'>
    <h1 className="text-2xl text-center font-semibold dark:text-slate-100 mb-5 underline underline-offset-8">Student About E-BookStore</h1>    
