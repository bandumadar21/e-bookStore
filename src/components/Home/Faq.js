...
const Faq = () => {
    const faqs = [
        {
          "id": 1,
          "question": "Why should I use E-BookStore?",
...
<div className="flex justify-center">
    <section className="my-1 p-7 border rounded dark:border-slate-700 w-3/4 ">        
      <h1 className="text-2xl text-cenetr font-semibold dark:text-slate-100 mb-3 underline underline-offset-8">Question in mind?</h1>    
            <div className="mt-7" id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
              { faqs.map((faq) => (
