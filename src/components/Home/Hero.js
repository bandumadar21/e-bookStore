...
const Hero = () => {
  return (
    <section className=" mt-11 flex flex-col lg:flex-row dark:text-slate-100 items-center justify-center">
        <div className="text my-5">
            <h1 className="text-4xl font-bold">The Ultimate eBook Store</h1>
            <p className="text-2xl my-7 px-1 dark:text-slate-300">e-BookStore is the world's most popular and authoritative source for computer science ebooks. Find ratings and access to the newest books digitally.</p>
